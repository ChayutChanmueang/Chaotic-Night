...
{
    public class Zone1Map6 : GameplayScreen
    {
        public Zone1Map6(Game1 game, EventHandler SEvent) : base(game, SEvent)
        {
            MapTex = game.Content.Load<Texture2D>("Tileset_Zone1_6");
            SpawnLC(50, 520);
