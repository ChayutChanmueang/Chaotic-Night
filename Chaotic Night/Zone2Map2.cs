...
{
    public class Zone2Map2 : GameplayScreen
    {
        public Zone2Map2(Game1 game, EventHandler SEvent) : base(game, SEvent)
        {
            MapTex = game.Content.Load<Texture2D>("Tileset_Zone2_2");
            SpawnLC(1008, 1800);
