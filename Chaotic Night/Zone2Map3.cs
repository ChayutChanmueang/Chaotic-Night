...
{
    public class Zone2Map3 : GameplayScreen
    {
        public Zone2Map3(Game1 game, EventHandler SEvent) : base(game, SEvent)
        {
            MapTex = game.Content.Load<Texture2D>("Tileset_Zone2_3");
