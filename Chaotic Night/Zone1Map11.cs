...
{
    public class Zone1Map11 : GameplayScreen
    {
        public Zone1Map11(Game1 game, EventHandler SEvent) : base(game, SEvent)
        {
            MapTex = game.Content.Load<Texture2D>("Tileset_Zone1_11");
            SpawnLC(400, 290);
