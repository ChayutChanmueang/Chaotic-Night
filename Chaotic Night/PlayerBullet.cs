...
namespace Chaotic_Night
{
    ...
    {
        public PlayerBullet(Vector2 SpawnPos, Texture2D Tex, float Rot, int Dmg):base(SpawnPos,Tex,Rot,Dmg)
        {
        ...
        public override void Draw(SpriteBatch SB, Vector2 CamPos)
        {
            ...
            SB.Draw(BulletTex, Pos - CamPos, new Rectangle(0, 2016, 144, 144), Color.White, Rotation, Vector2.Zero, 1, SpriteEffects.None, 0);
        }
