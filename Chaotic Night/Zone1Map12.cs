...
{
    public class Zone1Map12 : GameplayScreen
    {
        public Zone1Map12(Game1 game, EventHandler SEvent) : base(game, SEvent)
        {
            MapTex = game.Content.Load<Texture2D>("Tileset_Zone1_12");
            SpawnLC(1430, 1700);
