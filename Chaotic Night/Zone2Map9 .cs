...
{
    public class Zone2Map9 : GameplayScreen
    {
        public Zone2Map9(Game1 game, EventHandler SEvent) : base(game, SEvent)
        {
            MapTex = game.Content.Load<Texture2D>("Tileset_Zone2_9");
            SpawnLC(280, 1855);
