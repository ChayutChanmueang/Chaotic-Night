...
{
    public class Zone3Map7 : GameplayScreen
    {
        public Zone3Map7(Game1 game, EventHandler SEvent) : base(game, SEvent)
        {
            MapTex = game.Content.Load<Texture2D>("Tileset_Zone3_7(1)");
            SpawnLC(54, 1140);
