...
{
    public class Zone3Map9 : GameplayScreen
    {
        public Zone3Map9(Game1 game, EventHandler SEvent) : base(game, SEvent)
        {
            MapTex = game.Content.Load<Texture2D>("Tileset_Zone3_9(1)");
            SpawnLC(280, 1855);
