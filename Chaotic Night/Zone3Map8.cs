...
{
    public class Zone3Map8 : GameplayScreen
    {
        public Zone3Map8(Game1 game, EventHandler SEvent) : base(game, SEvent)
        {
            MapTex = game.Content.Load<Texture2D>("Tileset_Zone3_8(1)");
            SpawnLC(1692, 578);
