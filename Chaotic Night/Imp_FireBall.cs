...
{
    class Imp_FireBall : Bullet
    {
        public Imp_FireBall(Vector2 SpawnPos, Texture2D Tex, float Rot, int Dmg) : base(SpawnPos, Tex, Rot, Dmg)
        {
        ...
        {
            SB.Draw(BulletTex, Pos - CamPos, new Rectangle(144 * FramePosX, 144 * FramePosY, 144, 144), Color.White, Rotation, Vector2.Zero, 1, SpriteEffects.None, 0);
        }
