...
{
    public class Zone3Boss : GameplayScreen
    {
        public Zone3Boss(Game1 game, EventHandler SEvent) : base(game, SEvent)
        {
            MapTex = game.Content.Load<Texture2D>("Tileset_Zone3_13(1)");
            SpawnLC(902, 2078);
            ...
            SpawnEnemy(3, 1, 970, 1265, 855, 1080);
        }
