...
{
    public class Zone1Map3 : GameplayScreen
    {
        public Zone1Map3(Game1 game, EventHandler SEvent) : base(game, SEvent)
        {
            MapTex = game.Content.Load<Texture2D>("Tileset_Zone1_3");
