...
{
    public class Zone2Map7 : GameplayScreen
    {
        public Zone2Map7(Game1 game, EventHandler SEvent) : base(game, SEvent)
        {
            MapTex = game.Content.Load<Texture2D>("Tileset_Zone2_7");
            SpawnLC(54, 1140);
