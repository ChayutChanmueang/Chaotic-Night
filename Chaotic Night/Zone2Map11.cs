...
{
    public class Zone2Map11 : GameplayScreen
    {
        public Zone2Map11(Game1 game, EventHandler SEvent) : base(game, SEvent)
        {
            MapTex = game.Content.Load<Texture2D>("Tileset_Zone2_11");
            SpawnLC(400, 290);
