...
{
    public class Zone3Map5 : GameplayScreen
    {
        public Zone3Map5(Game1 game, EventHandler SEvent) : base(game, SEvent)
        {
            MapTex = game.Content.Load<Texture2D>("Tileset_Zone3_5(1)");
