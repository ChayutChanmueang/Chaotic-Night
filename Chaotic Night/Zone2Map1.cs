...
{
    public class Zone2Map1 : GameplayScreen
    {
        public Zone2Map1(Game1 game, EventHandler SEvent) : base(game, SEvent)
        {
            MapTex = game.Content.Load<Texture2D>("Tileset_Zone2_1");
            SpawnLC(511, 936);
