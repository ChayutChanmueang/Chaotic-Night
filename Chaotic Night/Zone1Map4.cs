...
{
    public class Zone1Map4 : GameplayScreen
    {
        public Zone1Map4(Game1 game, EventHandler SEvent) : base(game, SEvent)
        {
            MapTex = game.Content.Load<Texture2D>("Tileset_Zone1_4");
        ...
        public override void ResetRoom()
        {
            ...
            Pickup.Add(new SkillPotion(RAND.Next(54, 1380), RAND.Next(790, 1008)));
            Pickup.Add(new HealthPotion(RAND.Next(54, 1380), RAND.Next(790, 1008)));
            LoadCollectable();
        }
