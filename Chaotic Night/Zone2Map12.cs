...
{
    public class Zone2Map12 : GameplayScreen
    {
        public Zone2Map12(Game1 game, EventHandler SEvent) : base(game, SEvent)
        {
            MapTex = game.Content.Load<Texture2D>("Tileset_Zone2_12");
            SpawnLC(1430, 1700);
