...
{
    public class Zone1Map8 : GameplayScreen
    {
        public Zone1Map8(Game1 game, EventHandler SEvent) : base(game, SEvent)
        {
            MapTex = game.Content.Load<Texture2D>("Tileset_Zone1_8");
            SpawnLC(1692, 578);
