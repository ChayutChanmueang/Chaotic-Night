...
namespace Chaotic_Night
{
    public class TestMap : Screen
    {
        ...
        int EnemyNum = 1;
        public TestMap(Game1 game,EventHandler SEvent) : base(game,SEvent)
        {
            //set game's screen
            ...
            PlayerCha = new PlayableCharacter(game, new Vector2(48, 48));
            ...
            for (int i = 0; i < 3; i++)
            {
                Enemies.Add(new Enemy(game, new Vector2(RAND.Next(0, 1920))));
        ...
        public override void Draw(SpriteBatch _spriteBatch)
        {
            ...
            if (Debuging == true)
            {
                ...
                _spriteBatch.DrawString(font, PlayerCha.WeaponRot.ToString(), new Vector2(PlayerCha.CharacterPos.X - GameCamera.GetCamPos().X, (PlayerCha.CharacterPos.Y + 64) - GameCamera.GetCamPos().Y), Color.White);
