...
{
    public class Zone1Boss : GameplayScreen
    {
        public Zone1Boss(Game1 game, EventHandler SEvent) : base(game, SEvent)
        {
            MapTex = game.Content.Load<Texture2D>("Tileset_Zone1_13");
            SpawnLC(902, 2078);
            ...
            SpawnEnemy(0, 3, 970, 1265, 855, 1080);
            SpawnEnemy(1, 2, 970, 1265, 855, 1080);
        }
        public override void Update(GameTime gameTime)
        {
            ...
            if(game.NextLevel!= game.Z2M1)
            {
                game.NextLevel = game.Z2M1;
            }
