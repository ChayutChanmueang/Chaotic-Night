...
{
    public class Zone1Map2 : GameplayScreen
    {
        public Zone1Map2(Game1 game, EventHandler SEvent) : base(game, SEvent)
        {
            MapTex = game.Content.Load<Texture2D>("Tileset_Zone1_2");
            SpawnLC(1008, 1800);
