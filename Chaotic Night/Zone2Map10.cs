...
{
    public class Zone2Map10 : GameplayScreen
    {
        public Zone2Map10(Game1 game, EventHandler SEvent) : base(game, SEvent)
        {
            MapTex = game.Content.Load<Texture2D>("Tileset_Zone2_10");
            SpawnLC(2030, 1365);
